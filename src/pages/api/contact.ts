...
async function verifyTurnstileToken(token: string, ip: string | null, secret: string) {
  try {
...
async function hmac(key: string | ArrayBuffer, message: string) {
...
async function hmacHex(key: ArrayBuffer, message: string) {
